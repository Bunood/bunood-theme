...
def extend_bootinfo(bootinfo):
    ...
    try:
        ...
        # the stale-assets.json trap ARCHITECTURE.md section 6 documents.
        # Behaviour flag territory, not appearance — the flash rule does not
        # apply, since the studio only exists after a navigation.
