...
def extend_bootinfo(bootinfo):
    ...
    try:
        ...
        # The Report Studio bundle's hashed URL (assets.py is generated by
        # build.mjs). Threaded through boot because the studio is page-scoped:
        # hooks.py deliberately does not app_include it, and the page cannot
        # know a content-hashed filename any other way without falling back to
