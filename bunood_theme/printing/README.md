...
|---|---|---|
| بنود - فاتورة ضريبية (A4) | Sales Invoice | ZATCA قياسية: بيانات البائع والمشتري + VAT + QR |
| بنود - فاتورة ضريبية مبسطة (A4) | Sales Invoice | B2C — بيانات المشتري اختيارية، QR إلزامي |
| بنود - فاتورة ضريبية (حراري 80مم) | Sales Invoice | إيصال حراري + بيانات المشتري إن وُجدت |
| بنود - فاتورة مبسطة (حراري 80مم) | Sales Invoice | إيصال POS الكلاسيكي |
| بنود - عرض سعر (A4) | Quotation | عربي ومهيأ للإرسال للعميل |
...
| بنود - فاتورة (نقطي) | Sales Invoice | هيكل Courier أساس — **انسخه وعدّله لكل عميل** حسب نموذجه المطبوع مسبقاً |
| بنود - سند قبض / صرف | Payment Entry | العنوان يتبدّل تلقائياً (قبض/صرف/تحويل) + صندوق مبلغ + مراجع |
| بنود - سند قيد | Journal Entry | جدول مدين/دائن + الإجماليات |
| بنود - كشف حساب عميل | General Ledger | نموذج تقرير عربي لكشف حساب عميل |
...
- **القوالب مُدارة:** أي تعديل يدوي على قالب «بنود - …» أو «زاتكا - …» في الـ Desk **سيُستبدل مع
